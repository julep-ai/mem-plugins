...
```text
## YYYY-MM-DD HH:MM mem_id=M-XXXXXX thread=T-XXXXXX

One paragraph describing what changed, why, and how it affects ICP, signal, copy, proof path, suppression, or campaign policy.
```
