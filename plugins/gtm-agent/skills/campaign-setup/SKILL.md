...
10. Build the planner and worker graph with `../gtm-agent/references/campaign-planner.md` and `../gtm-agent/references/parallel-routines.md`.
...
14. Return the GTM plan from `references/gtm-plan.md`.
15. Record only after the user approves or edits the plan. Propose brief updates only when the approved plan changes reusable operating truth.
