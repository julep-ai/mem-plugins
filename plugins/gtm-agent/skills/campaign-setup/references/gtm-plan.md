...
- `context_sources`: Memory Store, uploaded/pasted docs, website, Gmail, Calendar, prior records or connector/workspace exports, Exa/Websets, and what each source is allowed to influence.
